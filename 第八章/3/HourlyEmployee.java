...
public class HourlyEmployee extends Employee 
{
    ...
    */
    public HourlyEmployee(String theName, Date theDate,
                       double theWageRate, double theHours,double theAdd)
    {
         super(theName, theDate);
         if ((theWageRate >= 0) && (theHours >= 0) && (theAdd >= 0))
         {
    ...
    */
    ...
    public void setAdd(double newAdd)
    {
         if (newAdd >= 0)
             add = newAdd;
         else
         {
             System.out.println("Fatal Error: Negative add.");
             System.exit(0);
         }
    }
