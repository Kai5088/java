...
public class AbstractClassDemo
{
    ...
    public static void main(String[] args)
    {
        ...
        a1 = new HourlyEmployee("Tom", new Date("January", 1, 2008), rate, b1,b4);
        ...
        if(a1.morePay(a2)) {
        	if(a1.morePay(a3))
        		System.out.print(Math.round(a1.getPay()));
        	else
        		System.out.print(Math.round(a3.getPay()));
        }
        else {
        	if(a2.morePay(a3))
        		System.out.print(Math.round(a2.getPay()));
        	else
        		System.out.print(Math.round(a3.getPay()));
        }
     }
